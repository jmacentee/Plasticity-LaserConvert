...
REM This file contains one object, RightWall
REM It has dimensions 3x72x164mm
REM It has 3 cutouts.
REM The application is currently not exporting this object with the output:
REM [TOPO] Adjusted dimensions: 2.0 x 72.0 x 164.0
REM [FILTER] RightWB: dimensions [2.0, 72.0, 164.0] - FAIL
REM No thin solids found.
REM find out why the thin dimension of this object is being calculated wrong.
"C:\Users\jdm\source\repos\Plasticity-LaserConvert\LaserConvert\bin\Debug\net10.0\LaserConvert.exe" "C:\Users\jdm\source\repos\Plasticity-LaserConvert\sample files\bigboxRW\rw.stp" "C:\Users\jdm\source\repos\Plasticity-LaserConvert\sample files\bigboxRW\rw.svg"  debugMode=true > "C:\Users\jdm\source\repos\Plasticity-LaserConvert\sample files\bigboxRW\rw_output.txt"
