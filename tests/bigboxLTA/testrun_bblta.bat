...
REM This STEP file contains one object, LidTabA
...
"C:\Users\jdm\source\repos\Plasticity-LaserConvert\LaserConvert\bin\Debug\net10.0\LaserConvert.exe" "C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigboxLTA\big box lid taba.stp" "C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigboxLTA\big box lid taba.svg"  debugMode=true > "C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigboxLTA\big box lid taba_output.txt"
...
set INPUTDIR=C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigboxLTA
