...
REM Inside the object "Lid" in the svg, the cutout should be 3x46mm
"C:\Users\jdm\source\repos\Plasticity-LaserConvert\LaserConvert\bin\Debug\net10.0\LaserConvert.exe" "C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigbox\big box v2.stp" "C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigbox\big box v2.svg"  debugMode=true > "C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigbox\big box v2_output.txt"
...
set INPUTDIR=C:\Users\jdm\source\repos\Plasticity-LaserConvert\tests\bigbox
