...
REM when all tests pass, the output from this test should be identical to KCBox.svg except for the different group name and possiblty it's rotation in the file
